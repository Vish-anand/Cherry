...
* **Execution Strategy:** Cherry launches an automated Chromium or Firefox browser instance. It injects user credentials retrieved securely from the credential vault, interacts with dynamically rendered elements, watches network payloads to capture API data, and reads text directly out of the page DOM.
